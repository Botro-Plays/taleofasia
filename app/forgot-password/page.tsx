...
const LeftPanel = () => (
  <div className="toa-auth-left">
    <div className="toa-auth-left-content">
      ...
      <p className="toa-auth-quote">A warrior who forgets the path home still knows the way forward.</p>
    </div>
  </div>
);
...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) { setError(data.error || 'Failed to send reset email'); }
        ...
        <div className="toa-auth-right">
          <div className="toa-auth-form-wrap">
            ...
            <div className="toa-auth-card">
              ...
              <h2 className="toa-auth-heading">Recover Access</h2>
              <p className="toa-auth-sub">Enter your email to reset your password</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {recaptchaEnabled && recaptchaSiteKey && (
                  <div className="flex justify-center mt-4 mb-2">
                    <ReCaptcha ref={recaptchaRef} siteKey={recaptchaSiteKey} version={recaptchaVersion} action="forgot_password" onVerify={setRecaptchaToken} />
                  </div>
                )}
