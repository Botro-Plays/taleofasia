      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="toa-content-card" style={{ lineHeight: 1.75 }}>
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Acceptance of Terms</h2>
            <p>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Accounts</h2>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Rules of Conduct</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Virtual Goods &amp; Payments</h2>
            <p>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Disclaimer</h2>
            <p>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Privacy</h2>
            <p>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Contact</h2>
            <p>
