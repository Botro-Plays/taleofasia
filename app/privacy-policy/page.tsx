      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="toa-content-card" style={{ lineHeight: 1.75 }}>
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Overview</h2>
            <p>
          ...
          <section id="cookies" style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Cookies</h2>
            <p className="mb-2">
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Data We Process</h2>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Google OAuth</h2>
            <p className="mb-2">
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Data Retention &amp; Deletion</h2>
            <p>
          ...
          <section style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--toa-font-display)', letterSpacing: '0.12em', color: 'var(--toa-gold)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Security</h2>
            <p>
